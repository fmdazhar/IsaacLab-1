...
gym.register(
    id="Isaac-Velocity-Flat-Unitree-A1-v1",
...
gym.register(
    id="Isaac-Velocity-Flat-Unitree-A1-Play-v1",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Rough-Unitree-A1-v1",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Velocity-Rough-Unitree-A1-Play-v1",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
